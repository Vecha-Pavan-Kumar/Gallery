                    ...
                    <ul class="nav navbar-nav navbar-right">
                      ...
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                          <li>
                            <a href="./AboutUs1.html">About IEEE</a>
                          </li>
                          <li>
                            <a href="./AboutUs1.html#IEEE GCET SB EXECOM">IEEE Execom</a>
                          </li>
                      ...
                      <li>
                        <a href="./IEEE-GCETSB1.html#IEEE-GCETSB1">About IEEE-GCETSB</a>
                      </li>
                      <li>
                        <a href="./IEEE-GCETSB WIE1.html">IEEE-GCETSB WIE</a>
                      </li>
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                          <li>
                            <a href="./ImageGallery.html">Images</a>
                          </li>
                          <li>
